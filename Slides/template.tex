...
\usepackage{tikz}
\usepackage{forest}
\usetikzlibrary{matrix,backgrounds,shapes.multipart,positioning,calc,chains,arrows}
...
$endif$
$if(institute)$
\institute{Federal University of ABC \\ Center for Mathematics, Computation and Cognition (CMCC) \\ Heuristics, Analysis and Learning Laboratory (HAL)}
$endif$
\date{$date$}
\titlegraphic{
